  ...
  return (
    <div className="text-black py-5 text-base  footer" id="footer">
      <div className="footerContent grid xl:grid-cols-3  lg:grid-cols-2  grid-cols-1">
        ...
        <div className=" px-5 my-3 footerPartner ">
          <h5 className="title">Đối tác</h5>
          ...
          <div className="mt-3 grid grid-cols-5 gap-5">
            ...
            <a target="_blank" rel="noopener noreferrer" href="Img/lotte.png">
              <img
        ...
        <div className="px-5 my-3 grid grid-cols-2 footerApp lg:col-span-2 xl:col-span-1">
          <div className="">
            ...
            <div className="mt-3 grid grid-cols-2">
              ...
              >
                <img className="logo" src="/Img/apple.png" alt="logo_apple" />
              </a>
              <a
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="">
            <h5 className="title">SOCIAL APP</h5>
            <div className="mt-3 grid grid-cols-2">
              <a
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <img className="logo" src="/Img/zalo.jpg" alt="logo_zalo" />
              </a>
            </div>
          </div>
        </div>
